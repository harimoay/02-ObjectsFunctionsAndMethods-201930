...
def main():
    ...
    """
    answer = get_hypotenuse(3, 4) # answer should be 5
    print(answer)
...
#
###############################################################################
def tempname(color, thickness):
    window = rg.TurtleWindow()
    yoshio = rg.SimpleTurtle()
    yoshio.pen = rg.Pen('green', thickness)
    yoshio2 = rg.SimpleTurtle()
    yoshio2.pen = rg.Pen(color, 5)
    yoshio.forward(100)
    yoshio2.backward(100)
