...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         Aaron Wilkin, their colleagues, and Yoshio Harimoto.
...
def try_methods():
    honu = rg.SimpleTurtle()
    honu.pen = rg.Pen('brown', 5)
    honu.forward(150)
    honu.left(90)
    honu.forward(50)
    honu.backward(100)
...
def try_methods_and_functions():
    ...
    tortoise = rg.SimpleTurtle()
    tortoise.pen = rg.Pen('blue',5)
    tortoise.backward(150)
    tortoise.speed = 1
    draw_many_squares(tortoise, 2, 100, 30)
    tortoise.speed = 5
    tortoise.pen = rg.Pen('red', 5)
    draw_many_squares(tortoise, 10, 50, 15)
    tortoise.speed = 100
    tortoise.pen = rg.Pen('red', 35)
    draw_many_squares(tortoise, 8, 300, 60)
    tortoise.pen = rg.Pen('black', 3)
    tortoise.backward(200)
    tortoise.draw_circle(30)
    tortoise.draw_square(50)
